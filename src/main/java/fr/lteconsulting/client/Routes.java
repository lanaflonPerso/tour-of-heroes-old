...
import fr.lteconsulting.client.material.EmailApplicationComponent_AngularComponent;
...
public class Routes implements ProviderWrapper
{
	...
	public Object get()
	{
		return RouterModule.forRoot( JsArray.of(
				...
				RouterConfig.route( "email", EmailApplicationComponent_AngularComponent.getComponentPrototype() ) ),

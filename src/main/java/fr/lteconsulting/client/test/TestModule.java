...
@NgModule(imports = {BrowserModule.class, FormsModule.class}, declarations = { MainComponent.class, ChildComponent.class,
		...
		MissionControlComponent.class, AstronautMissionComponent.class, TestComponent.class, HeroBiosAndContactsComponent.class, HeroBioComponent.class, HeroContactComponent.class },
		providers = LoggerService.class,
		entryComponents = TestComponent.class, bootstrap = MainComponent.class)
@JsType
